...
public class ReturningFragment extends Fragment {
    ...
    private  MyAibotBean.ObjBean.ResultBean returnbean;
    private MapView mReturnmapview;
    private AMap aMap;
    private AMapLocationClient mLocationClient;
    private AMapLocationClientOption mLocationClientOption;
    @SuppressLint({"NewApi", "ValidFragment"})
    public ReturningFragment(Context context, MyAibotBean.ObjBean.ResultBean returnbean) {
    ...
    private void initId(View view) {
        ...
        TextView tvName = (TextView) view.findViewById(R.id.tv_return_name);
        TextView tvPhone = (TextView) view.findViewById(R.id.tv_return_phone);
        TextView tvAdd = (TextView) view.findViewById(R.id.tv_return_address);

        Button btnRepay = (Button) view.findViewById(R.id.btn_repay_return);
        tvLend.setText(returnbean.getLeaseFrom2()+"");
        tvRepay.setText(returnbean.getLeaseTo2()+"");
        tvReturnId.setText(returnbean.getProductId()+"");
        tvName.setText(returnbean.getCzUser());
        tvPhone.setText(returnbean.getCzMobile()+"");
        tvAdd.setText(returnbean.getCzAddress()+"");
    }
