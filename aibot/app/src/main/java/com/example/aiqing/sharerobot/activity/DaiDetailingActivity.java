...
//投放商进出货详情
public class DaiDetailingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailing_dai);
        ...
        topMenu.topMenuLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              DaiDetailingActivity.this.finish();
                Log.d("返回", "onClick: " + "返回");
            }
        });
        initId();
    ...
    private void initData() {
        ...
        Retrofit builder=new Retrofit.Builder()
                ...
                .baseUrl("http://120.132.117.157:8083/agency/agencyOrderDetails.shtml")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        ApiService apiService = builder.create(ApiService.class);
        Call<DaiDetailingBean> call = apiService.daiDetail(cookie, paId);
        call.enqueue(new Callback<DaiDetailingBean>() {
            @Override
            public void onResponse(Response<DaiDetailingBean> response, Retrofit retrofit) {
